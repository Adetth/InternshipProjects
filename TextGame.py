...
class TextGame:
    ...
    def update_story(self):
        if self.page_number == 1:
            ...
            self.story_text.set("Your navigation appears to have failed, but a glimmer of hope shines as a unknown entity relays a message providing you with assistance.\nWhat will you do?")
            ...
            self.story_text.set("You come across an abandoned power facility, and has the equipment required to restore power to your ship.\nYou use the equipment in hopes to power up your spaceship\nAll the power in your starship has been restored and all functionality has been restored.\nThe navigation suddenly pings a place of intrest, a Goldilocks zone a couple lightyears from your current planet\nWhat will you do?")
            ...
            self.choice_text.set("1. Try going to cryosleep inorder to save oxygen and hope that someone can find you\n2. Use the last of your power to warp to a random location")
            ...
            self.choice_entry.pack_forget()
            self.submit_button.pack_forget()
            self.story_text.set("The earbud turns out to be a universal translator. The aliens look at you expecting you to answer to them.\nYou can understand them now. They are asking you to join thier crew and help them till you earn enough credits to repair your ship and go home.\nYou go along with them and finally what seems to be years later repay them for the repairs and set your warp back home.")
        
        elif self.page_number == 15:
            self.choice_label.pack_forget()
            self.choice_entry.pack_forget()
            self.submit_button.pack_forget()
            self.story_text.set("The remote has a few buttons and you click the glowing button. And all of a sudden youre home!\nThe device that was lent to you appears to be a teleporter. A device that enables multidimensional travel.\nYou are rejoiced as a hero and statues are built of you in your hometown.\nScientists are greateful to you for bringing back the teleporter, everything is peaceful for many years.\nBut then the sky goes dark, an Unidentified flying object appears in the sky and wipes the entire city clean with one ray\nThe aliens put your picture up everywhere and demand your head. Turns our the teleporter was a priced universally and your dissapearance meant that every planet that housed humans had to be destroyed.\nYou brought upon the end of humanity.\nThe End")
