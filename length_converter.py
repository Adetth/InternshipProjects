...
Original file is located at
    https://colab.research.google.com/drive/15IjhlfF5Og-pmfFdCrIPwUANJcSh6zqo
"""
...
if mainchc == 1 or mainchc == '1':
  ...
  while rpt == 'y':
    try:
      #User Input
      userin = float(input("Enter the lenght in meters : \n"))
      proceed = True
      break
...
if mainchc == 2 or mainchc == '2':
  ...
  while rpt == 'y':
    try:
      #User Input
      userin = float(input("Enter the lenght in feet : \n"))
      proceed = True
      break
